<template>
  <button
    :class="[
      ...
      'focus:outline-none focus:ring-2 focus:ring-breathe-light-primary',
  ...
  >
    ...
    <!-- Button Text -->
    <span class="text-breathe-dark-primary font-medium">
...
.google-auth-button {
  ...
  /* Primary Light for focus ring */
  --focus-ring-color: var(--breathe-light-primary);
}
</style>
